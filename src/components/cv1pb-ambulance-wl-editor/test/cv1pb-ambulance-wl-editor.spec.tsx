...
import { Cv1pbAmbulanceWlEditor } from '../cv1pb-ambulance-wl-editor';
...
describe('cv1pb-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [Cv1pbAmbulanceWlEditor],
      html: `<cv1pb-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></cv1pb-ambulance-wl-editor>`,
    });
